...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {!showSidebar && (
        <button
          className={`md:hidden text-green-500 bg-white fixed top-24 ${isArabic ? "right-4" : "left-4"
            } z-[999]`}
    ...
    md:relative md:translate-x-0 md:w-60 md:mt-5 md:rounded-2xl`}
      >
        ...
        <div className="flex justify-between items-center mb-4 md:hidden">
          <div className="font-bold text-lg">Haat</div>
        ...
        {/* <div className="font-semibold mb-6 hidden md:block">Haat</div> */}
